...
# - Cost: $0 (free!)
# - Quality: -42.6 dB separation, λ=0.17 average
# - BPSK patterns: 20-30% achieve λ=0 (maximum robustness)
```

### Local Mid-Range CPU (Balanced)
```bash
# Balanced: 8 trials × 200K iterations
...
# Expected: 36-48 hours, $0 cost, -41.5 dB quality, λ=0.19
```

### Cloud (Fast Alternative - No Local Hardware)
```bash
# Breadth strategy: 32 workers × 100K iterations
...
# Expected: 30-40 hours, $9.60 cost, -40.7 dB quality, λ=0.22
